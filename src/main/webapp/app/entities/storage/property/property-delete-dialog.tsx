...
export const PropertyDeleteDialog = (props: IPropertyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.storageProperty.delete.question">
        <Translate contentKey="gatewayApp.storageProperty.delete.question" interpolate={{ id: propertyEntity.id }}>
