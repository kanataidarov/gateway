...
export const PropertyGroup = (props: IPropertyGroupProps) => {
  ...
  return (
    <div>
      <h2 id="property-group-heading">
        <Translate contentKey="gatewayApp.storagePropertyGroup.home.title">Property Groups</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gatewayApp.storagePropertyGroup.home.createLabel">Create new Property Group</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('gatewayApp.storagePropertyGroup.home.search')}
                />
...
export default connect(mapStateToProps, mapDispatchToProps)(PropertyGroup);
