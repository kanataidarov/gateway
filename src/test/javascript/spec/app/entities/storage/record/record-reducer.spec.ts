...
import { IRecord, defaultValue } from 'app/shared/model/storage/record.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_RECORD_LIST), REQUEST(ACTION_TYPES.SEARCH_RECORDS), REQUEST(ACTION_TYPES.FETCH_RECORD)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_RECORDS),
  ...
  describe('Successes', () => {
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_RECORDS),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.SEARCH_RECORDS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_RECORDS)
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_RECORDS),
          payload: resolvedObject
